    ...
    <section className="p-6 grid gap-6">
      ...
      <form onSubmit={submit} className="grid gap-3 bg-white/70 backdrop-blur border rounded-2xl p-4 shadow">
        <div>
          ...
          <textarea className="w-full border rounded-lg px-3 py-2 min-h-[120px] bg-white/80" value={text} onChange={(e)=>setText(e.target.value)} placeholder="Describe your issue or feedback..." required />
        </div>
