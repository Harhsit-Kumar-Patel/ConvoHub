  ...
  return (
    <section className="p-6 space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Column title="To Do" items={groups.todo} color="border-sky-500" onStatusChange={updateTaskStatus} isAdmin={isAdmin} />
        <Column title="In Progress" items={groups['in-progress']} color="border-amber-500" onStatusChange={updateTaskStatus} isAdmin={isAdmin} />
        <Column title="Done" items={groups.done} color="border-emerald-500" onStatusChange={updateTaskStatus} isAdmin={isAdmin} />
      </div>
    </section>
  );
}

function Column({ title, items, color, onStatusChange, isAdmin }) {
  return (
